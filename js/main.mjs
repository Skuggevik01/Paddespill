...
class playGame extends Phaser.Scene {
    ...
    preload() { // loading assets
        ...
        this.load.image("wheel", "http://localhost:5500/" + targetWhelImage);
        this.load.image("pin",  "http://localhost:5500/" + "Images/pin.png");
        this.load.image("froskbanner", "http://localhost:5500/" + "Images/froskbanner.png");
